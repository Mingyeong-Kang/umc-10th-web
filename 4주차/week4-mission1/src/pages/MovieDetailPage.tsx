...
const MovieDetailPage = () => {
  ...
  //커스텀 훅 사용
  const {data: movie, isPending: isMoviePending, isError: isMovieError} = useCustomFetch<MovieDetail>(
    `/movie/${movieId}?language=ko-KR`
  );

    //커스텀 훅 사용
  const {data: credits, isPending: isCreditPending, isError: isCreditError} = useCustomFetch<MovieCredit>(
